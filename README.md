...
🚀 Featured Projects
🔹 TravelEase – Microservices Travel Booking Platform

A cloud-native project with booking, flight and payment services deployed on AWS ECS Fargate using Terraform.
...
Simple containerized app with automated build and test workflow using GitHub Actions.
